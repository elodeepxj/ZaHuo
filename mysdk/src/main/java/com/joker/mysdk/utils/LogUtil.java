    ...
    public static class Builder {
        ...
        public Builder() {
            if (Environment.MEDIA_MOUNTED.equals(Environment.getExternalStorageState())) {
                dir = BaseApplication.getApplication().getExternalCacheDir() + File.separator + "log" + File.separator;
            } else {
                dir = BaseApplication.getApplication().getCacheDir() + File.separator + "log" + File.separator;
            }
        }
